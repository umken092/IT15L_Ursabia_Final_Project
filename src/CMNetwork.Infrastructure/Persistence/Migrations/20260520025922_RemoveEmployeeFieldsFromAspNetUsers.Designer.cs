...
namespace CMNetwork.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260520025922_RemoveEmployeeFieldsFromAspNetUsers")]
    partial class RemoveEmployeeFieldsFromAspNetUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.BankDirectoryEntry", b =>
                {
                    ...
                    b.Property<string>("AccountNumberPattern")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("AccountNumberSample")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Country = "Philippines",
                            IsActive = true,
                            ListedAtUtc = new DateTime(2026, 5, 11, 0, 0, 0, 0, DateTimeKind.Utc),
                            ListedBy = "system",
                            Name = "BDO"
                        },
                        new
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.BankStatement", b =>
                {
                    ...
                    b.Property<Guid?>("BankDirectoryId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime?>("RegistrationOtpGeneratedUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.EmployeeProfile", b =>
                {
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.IntegrationCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.PayrollLineItem", b =>
                {
                    ...
                    b.Property<bool>("IsExceptionFlag")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("PhilHealthFee")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CMNetwork.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("LastPayrollProcessed")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.BankStatement", b =>
                {
                    b.HasOne("CMNetwork.Domain.Entities.BankDirectoryEntry", "BankDirectory")
                        .WithMany()
                        .HasForeignKey("BankDirectoryId")
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.EmployeeProfile", b =>
                {
                    b.HasOne("CMNetwork.Infrastructure.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("CMNetwork.Domain.Entities.EmployeeProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.PayrollLineItem", b =>
                {
                    b.HasOne("CMNetwork.Domain.Entities.PayrollRun", "PayrollRun")
                        .WithMany("LineItems")
            ...
            modelBuilder.Entity("CMNetwork.Domain.Entities.PayrollRun", b =>
                {
                    ...
                    b.HasOne("CMNetwork.Domain.Entities.PayPeriod", "PayPeriod")
            ...
            modelBuilder.Entity("CMNetwork.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.HasOne("CMNetwork.Domain.Entities.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
