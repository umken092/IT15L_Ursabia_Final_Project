...
export const menuByRole: Record<Role, SidebarMenuItem[]> = {
  ...
  'faculty-admin': [
    { label: 'Department Dashboard', path: dashboardPath('faculty-admin') },
    { label: 'Department Report', path: '/module/department-report' },
    { label: 'Approvals Queue', path: '/module/approvals' },
    { label: 'Budget & Cost Control', path: '/module/budget-cost-control' },
  ],
  employee: [
